!(function(e, t) {
  ...
  function G(e, t, n) {
    ...
    return (
      t === B && (e = X(e, fe(e) % 10, 'year')),
      t === Y && (e = X(e, fe(e) % 100, 'year')),
      t === H &&
        (e = (function(e, t, n) {
          var r = (ce(e) + 7 - (n || 0)) % 7
  ...
  function q(e, t, n) {
    return (e = X((e = $((e = G((e = new Date(e)), t, n)), 1, t)), 1, L))
  }
  ...
  function qe(e, t, n) {
    ...
    var r = typeof t
    return (
      !!('number' == r ? Ye(n) && Ge(t, n.length) : 'string' == r && t in n) &&
      Oe(n[t], e)
    )
  }
  function Ke(e) {
  ...
  function Je(e) {
    return 'symbol' == typeof e || (Ke(e) && Le(e) == Ze)
  }
  var Qe = NaN,
    et = /^\s+|\s+$/g,
    tt = /^[-+]0x[0-9a-f]+$/i,
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              a({}, _, {
                tabIndex: 0,
                style: a({}, k.style, t),
                className: D('rbc-event', n, k.className, {
                  'rbc-selected': i,
                  'rbc-event-allday': j,
  ...
  for (
    var Vt = 'undefined' != typeof window && 'undefined' != typeof document,
      Ut = ['Edge', 'Trident', 'Firefox'],
      Bt = 0,
      Yt = 0;
    Yt < Ut.length;
    Yt += 1
  )
    if (Vt && navigator.userAgent.indexOf(Ut[Yt]) >= 0) {
      Bt = 1
      break
    }
  var $t =
  ...
  var Zt = Vt && !(!window.MSInputMethodContext || !document.documentMode),
    Jt = Vt && /MSIE 10/.test(navigator.userAgent)
  function Qt(e) {
  ...
  var Nn = Vt && /Firefox/i.test(navigator.userAgent)
  function Cn(e, t, n) {
    var r = _n(e, function(e) {
        return e.name === t
      }),
  ...
  var or = r.forwardRef(function(e, n) {
    ...
    return y ? o.createPortal(V, y) : null
  })
  function ir(e, t) {
    var n = wt(e)
  ...
  function Wr(e) {
    return (
      !(!Fe(e) || ((t = e), Nr && Nr in t)) && (Ve(e) ? zr : Ar).test(Rr(e))
    )
    var t
  }
  function Hr(e, t) {
  ...
  var Uo = 'object' == typeof e && e && !e.nodeType && e,
    ...
    Yo = Bo && Bo.exports === Uo && Me.process,
    $o = (function() {
      try {
    ...
    Go = Xo
      ? Vo(Xo)
      : function(e) {
          return Ke(e) && Be(e.length) && !!Ho[Le(e)]
        },
  ...
  var Vi = 1 / 0,
    Ui = xe ? xe.prototype : void 0,
    Bi = Ui ? Ui.toString : void 0
  function Yi(e) {
    if ('string' == typeof e) return e
    if (So(e)) return Hi(e, Yi) + ''
  ...
  function os(e) {
    var t,
      ...
      h = e.onClick,
      m = e.onDoubleClick,
      v = e.components.backgroundEventWrapper,
      g = s.tooltip(i),
      y = s.end(i),
      b = s.start(i),
        ...
        (t.renderEvents = function(e) {
          ...
          return (function(e) {
            ...
            var i,
              ...
              b = m.startsBeforeDay(g),
              w = m.startsAfterDay(h)
            b
              ? (y = 'eventTimeRangeEndFormat')
              : w && (y = 'eventTimeRangeStartFormat'),
              (i = b && w ? v.allDay : l.format({ start: g, end: h }, y))
            var E = b || m.startsBefore(g),
              _ = w || m.startsAfter(h),
              O = {
                style: p,
                event: d,
    ...
    return (
      ...
      (n.render = function() {
        var e = this,
          ...
          b = void 0 === y ? us : y,
          w = {}
        m && (w[o ? 'marginLeft' : 'marginRight'] = ls() + 'px')
      ...
      (o.renderEvents = function(e, t, n, o) {
        ...
        return h.map(function(t, n) {
          ...
          return e.map(function(e, t) {
            var g = (m.get(s) || []).filter(function(t) {
        ...
        return (
          t.forEach(function(e) {
            if (ca(e, y, b, f)) {
              var t = f.start(e),
                n = f.end(e)
              f.allDay(e) || (we(t) && we(n)) || (!v && !K(t, n, 'day'))
                ? w.push(e)
                : E.push(e)
            }
          }),
  ...
  ;(ms.propTypes = {}),
    (ms.defaultProps = ps.defaultProps),
  ...
  ;(gs.propTypes = {}),
    (gs.defaultProps = ps.defaultProps),
    (gs.range = vs),
    (gs.navigate = ms.navigate),
            ...
            if (n.tbodyRef.current) {
              ...
              if (t) {
                var r,
                  ...
                  a = n._widths || []
                ;(n._widths = [cs(t.children[0]), cs(t.children[1])]),
                  ...
                  i
                    ...
                    : (function(e, t) {
                        e.classList
                          ...
                          ? (e.className = ys(e.className, t))
                          : e.setAttribute(
                              'class',
                              ys((e.className && e.className.baseVal) || '', t)
                            )
  ...
  ;(ws.propTypes = {}),
    ...
    (ws.range = function(e, t) {
      ...
      return {
        start: e,
        end: $(e, void 0 === n ? ws.defaultProps.length : n, 'day'),
      }
    }),
  ...
  function xs(e, t, n) {
    var r = e[t]
    ;(Ds.call(e, t) && Oe(r, n) && (void 0 !== n || t in e)) || Ss(e, t, n)
  }
  function Ts(e, t, n, r) {
    var o = !n
    n || (n = {})
    for (var i = -1, a = t.length; ++i < a; ) {
      ...
      void 0 === c && (c = e[s]), o ? Ss(n, s, c) : xs(n, s, c)
    }
    return n
  }
  ...
  function Ns(e) {
    return Ye(e) ? Ko(e, !0) : ks(e)
  }
  var Cs = 'object' == typeof e && e && !e.nodeType && e,
    Rs =
      Cs && 'object' == typeof module && module && !module.nodeType && module,
    As = Rs && Rs.exports === Cs ? De.Buffer : void 0,
    Ps = As ? As.allocUnsafe : void 0
  var Ls = Qo(Object.getPrototypeOf, Object),
    Fs = Object.getOwnPropertySymbols
      ? function(e) {
          for (var t = []; e; ) Mo(t, ko(e)), (e = Ls(e))
          return t
        }
      : xo
  function Is(e) {
  ...
  var Hs = /\w*$/
  var Vs = xe ? xe.prototype : void 0,
    Us = Vs ? Vs.valueOf : void 0
  ...
  function lc(e, t, n) {
    ...
    switch (t) {
      ...
      case qs:
        return new a()
      case Zs:
        return (r = e), Us ? Object(Us.call(r)) : {}
    }
  }
  ...
  function Dc(e, t, n, r, o, i) {
    ...
    return (
      Ms(m || e, function(r, o) {
        m && (r = e[(o = r)]), xs(a, o, Dc(r, t, n, o, e, i))
      }),
      a
    )
  }
  ...
  ;(Sc[Ec] = Sc['[object Array]'] = Sc['[object ArrayBuffer]'] = Sc[
    '[object DataView]'
  ] = Sc['[object Boolean]'] = Sc['[object Date]'] = Sc[
    '[object Float32Array]'
  ] = Sc['[object Float64Array]'] = Sc['[object Int8Array]'] = Sc[
    '[object Int16Array]'
  ] = Sc['[object Int32Array]'] = Sc['[object Map]'] = Sc[
    '[object Number]'
  ] = Sc[Mc] = Sc['[object RegExp]'] = Sc['[object Set]'] = Sc[
    '[object String]'
  ] = Sc['[object Symbol]'] = Sc['[object Uint8Array]'] = Sc[
    '[object Uint8ClampedArray]'
  ] = Sc['[object Uint16Array]'] = Sc['[object Uint32Array]'] = !0),
    (Sc['[object Error]'] = Sc[_c] = Sc['[object WeakMap]'] = !1)
  var Tc = '[object Object]',
    jc = Function.prototype,
    kc = Object.prototype,
    Nc = jc.toString,
    Cc = kc.hasOwnProperty,
    Rc = Nc.call(Object)
  function Ac(e) {
    return (function(e) {
      if (!Ke(e) || Le(e) != Tc) return !1
      var t = Ls(e)
      if (null === t) return !0
      var n = Cc.call(t, 'constructor') && t.constructor
      return 'function' == typeof n && n instanceof n && Nc.call(n) == Rc
    })(e)
      ? void 0
      : e
  }
    ...
    zc = Xa(function(e, t) {
      ...
      for (o && qe(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var i = t[n], a = Ns(i), s = -1, c = a.length; ++s < c; ) {
          var l = a[s],
            u = e[l]
          ;(void 0 === u || (Oe(u, Fc[l]) && !Ic.call(e, l))) && (e[l] = i[l])
        }
      return e
    })
  var Wc = function(e) {
          ...
          return Array.isArray(o)
            ? (function(e, t, n) {
                ...
                if (((t = ra(t)), null == n)) {
                  ...
                  n = o ? (r ? new i() : []) : Fe(e) && Ve(i) ? fc(Ls(e)) : {}
                }
                return (
                  (o ? Ms : Pa)(e, function(e, r, o) {
                    return t(n, e, r, o)
                  }),
                  n
                )
  ...
  var Uc = (function e(t, n, o) {
    ...
    })(Vc, { view: 'onView', date: 'onNavigate', selected: 'onSelectEvent' }),
    Bc = function(e, t, n) {
      var r = e.start,
        o = e.end
