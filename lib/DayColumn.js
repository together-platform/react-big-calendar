...
var _TimeGridBackgroundEvent = _interopRequireDefault(
  require('./TimeGridBackgroundEvent')
)
  ...
  (function(_React$Component) {
    ...
    function DayColumn() {
      ...
      _this.renderEvents = function(_ref) {
        var isBackgroundEvent = _ref.isBackgroundEvent,
          events = _ref.events
        ...
        return styledEvents.map(function(_ref2, idx) {
          ...
          if (isBackgroundEvent) {
            return _react.default.createElement(
              _TimeGridBackgroundEvent.default,
              settings
            )
          }

          return _react.default.createElement(_TimeGridEvent.default, settings)
        })
      }
...
DayColumn.propTypes =
  process.env.NODE_ENV !== 'production'
    ? {
        ...
        backgroundEvents: _propTypes.default.array,
